...
def start(update, context) :
    ...
    while True :
        ...
        if h.hour == 23 :
            context.bot.send_message(chat_id=update.effective_chat.id, text= 'Начал парсить скидончики',parse_mode=telegram.ParseMode.HTML)
            ...
            context.bot.send_message(chat_id=update.effective_chat.id, text= 'Парсинг закончил. Щас пришлю',parse_mode=telegram.ParseMode.HTML)
